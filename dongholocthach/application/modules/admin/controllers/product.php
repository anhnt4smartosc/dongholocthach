...
class product extends BaseAdminController
{
    ...
    private function uploadMainImage() {
        ...
        if ($fileInfo['name'] != null) {
            ...
            move_uploaded_file($fileInfo['tmp_name'], "public/products/images/" . $fileName);
        }
        return $fileName;
    }
    ...
    public function edit($id='')
    {
        ...
        if (isset($_POST['btnok']) )
        {
            ...
            {
                // echo '';
                $up_imgs = $this->upload->do_upload_multiple("upload_images", '/product/' . $id);
            ...
            $rata['page_title'] = "Thay đổi thanh công";
            $rata['template'] = "product/product_update_success";

            $this->loadView("template/layout", $rata);
    ...
    public function delete_image($id = '')
    {
        ...
        if ($delete_id !== false ){
            ...
            {
                $this->remove_image($delete);
                $delete = explode('_', $delete);
                $delete = end($delete);
                $this->image_model->delete_image_product($delete , $id);
            }
        }
